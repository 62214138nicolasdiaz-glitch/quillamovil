<?php
// conductor-motocarga.php
session_start();

// Verificar si el usuario está autenticado
if (!isset($_SESSION['user'])) {
    header('Location: login.php?redirect=conductores-motocarga.php');
    exit;
}
...
// Obtener los conductores registrados con Motocarga
$query = "SELECT dni, nombre, apellido, vehiculo, tipo_lic, telefono, estado FROM conductor WHERE vehiculo = 'Motocarga'";
$result = mysqli_query($conn, $query);
?>

<div class="container mt-5">
  <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    <h2 class="mb-0">Conductores Motocarga</h2>
