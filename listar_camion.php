...
<body>
  <div class="container py-4">
    <h1 class="text-center mb-3">Listar Camiones</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-dark text-white border border-danger">
          <div class="modal-header border-bottom border-secondary">
            <h5 class="modal-title" id="detalleModalLabel">Detalle del camión</h5>
          ...
          <div class="modal-body">
            <div class="detalle-grid">
              ...
              <div class="detalle-row"><strong>Apellido</strong><span id="detalle-apellido"></span></div>
  ...
  <script>
    ...
    function abrirModalDetalles(btn) {
      ...
      var estadoEl = document.getElementById('detalle-estado');
      if (estadoEl) {
